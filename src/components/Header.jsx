...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      {/* Top Bar */}
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white text-sm py-2">
        <div className="container mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-2">
          <div className="flex items-center gap-2">
            <span className="hidden sm:inline">🇵🇰 Pakistan's Trusted Electric Store</span>
            <span className="sm:hidden text-xs">Electro.pk - Electric Store</span>
          </div>
          <div className="flex items-center gap-4 flex-wrap justify-center">
            <a href={`tel:${contactInfo.phone.replace(/\s/g, '')}`} className="flex items-center gap-1 hover:text-yellow-400 transition-colors">
              <PhoneIcon className="w-4 h-4" />
              <span className="hidden sm:inline">{contactInfo.phone}</span>
              <span className="sm:hidden">Call Now</span>
            </a>
            <span className="hidden sm:inline text-gray-500">|</span>
            <a href={`mailto:${contactInfo.email}`} className="flex items-center gap-1 hover:text-yellow-400 transition-colors">
          ...
          <ul className="flex items-center gap-8 py-3">
            ...
            <li className="ml-auto">
              <a 
                ...
                className="bg-green-500 text-white px-4 py-2 rounded-full flex items-center gap-2 hover:bg-green-600 transition-all hover:scale-105 shadow-lg hover:shadow-xl"
              >
        ...
        <div className="md:hidden bg-white border-t border-gray-100">
          ...
          <div className="p-4 border-t border-gray-100">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="block w-full bg-green-500 text-white text-center py-3 rounded-lg font-semibold hover:bg-green-600 transition-all shadow-lg"
            >
              📱 Order on WhatsApp
            </a>
          </div>
